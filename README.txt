...
7. Users should be able to rate videos, an overall rating for each video should also be displayed.
   Done(Users can rate a video multiple time.)
...
4. UI design should be clean and polished.
   Done.
5. UI should be cross-browser compatible.
   Done. (Was unable to test on IE)
6. UI should be cross-device compatible
   Done.


How to run project.

1. MongoDb should be running at 127.0.0.1:27017
2. Open terminal and go to code folder
...
1. Open terminal and go to client folder in project
